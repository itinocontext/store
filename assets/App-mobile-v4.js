...
function ProductCard({ product, index, total, onAdd, }) {
    ...
    return (_jsx("div", { ref: containerRef, className: "product-card-container relative mb-8 h-auto min-h-0 lg:mb-0 lg:h-[92vh] lg:min-h-[720px]", children: _jsx(motion.article, { style: { '--sticky-top': `${96 + index * 18}px` }, className: "product-card relative mx-auto grid h-auto min-h-0 max-w-7xl overflow-visible rounded-[36px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-3 sm:rounded-[50px] sm:p-6 md:rounded-[60px] md:p-8 lg:sticky lg:h-[76vh] lg:min-h-[610px] lg:overflow-hidden", children: _jsxs("div", { className: "grid h-auto gap-3 sm:gap-4 lg:h-full lg:grid-cols-[.8fr_1.2fr] lg:gap-6", children: [_jsxs("div", { className: "relative flex min-h-[235px] flex-col justify-between overflow-hidden rounded-[28px] p-5 sm:min-h-[280px] sm:rounded-[40px] sm:p-7", style: { backgroundColor: product.bg }, children: [_jsxs("div", { className: "relative z-20 flex items-start justify-between gap-4", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs font-medium uppercase tracking-[0.2em] text-white/70", children: product.capsule }), _jsxs("p", { className: "mt-2 font-anton text-[clamp(3.5rem,8vw,8rem)] leading-none text-white", children: ["0", index + 1] })] }), _jsx("span", { className: "rounded-full border border-white/50 px-4 py-2 text-[10px] uppercase tracking-[0.18em] text-white", children: product.color })] }), _jsx("img", { src: product.src, alt: `${product.name} — ${product.color}`, loading: "lazy", className: "pointer-events-none absolute bottom-[-16%] left-1/2 h-[112%] w-auto max-w-none -translate-x-1/2 object-contain drop-shadow-[0_30px_35px_rgba(0,0,0,.35)] sm:bottom-[-24%] sm:h-[128%]" }), _jsx("p", { className: "relative z-20 max-w-[180px] text-xs uppercase leading-relaxed tracking-[0.14em] text-white/75", children: product.note })] }), _jsxs("div", { className: "relative z-10 flex min-h-0 flex-col justify-between overflow-visible rounded-[28px] border border-white/12 bg-[#111] p-5 pb-7 sm:rounded-[40px] sm:p-7 md:p-9", children: [_jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-5", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-[#D7E2EA]/55", children: "Current piece" }), _jsx("h3", { className: "mt-4 max-w-xl text-[clamp(2rem,4vw,4.8rem)] font-semibold uppercase leading-[.92] tracking-[-.035em] text-[#D7E2EA]", children: product.name })] }), _jsx("span", { className: "whitespace-nowrap text-lg font-medium text-[#D7E2EA] sm:text-2xl", children: product.price })] }), _jsxs("div", { className: "my-5 grid gap-5 border-y border-white/12 py-5 sm:my-6 sm:grid-cols-2 sm:gap-8 sm:py-7", children: [_jsxs("div", { children: [_jsx("p", { className: "mb-3 text-[10px] uppercase tracking-[0.2em] text-[#D7E2EA]/50", children: "Colour" }), _jsxs("div", { className: "flex items-center gap-3 text-sm uppercase tracking-wider text-[#D7E2EA]", children: [_jsx("span", { className: "h-5 w-5 rounded-full border border-white/40", style: { backgroundColor: product.bg } }), product.color] })] }), _jsxs("div", { children: [_jsx("p", { className: "mb-3 text-[10px] uppercase tracking-[0.2em] text-[#D7E2EA]/50", children: "Select size" }), _jsx("div", { className: "flex flex-wrap gap-2", children: SIZES.map((option) => (_jsx("button", { type: "button", onClick: () => setSize(option), className: cn('relative z-30 h-12 min-w-12 touch-manipulation rounded-full border px-3 text-sm font-medium transition active:scale-95', size === option
                                                        ? 'border-[#D7E2EA] bg-[#D7E2EA] text-[#0C0C0C]'
                                                        : 'border-white/25 text-[#D7E2EA] hover:border-white'), children: option }, option))) })] })] }), _jsxs("div", { className: "flex flex-col gap-4 pb-[max(4px,env(safe-area-inset-bottom))] sm:flex-row sm:items-center sm:justify-between", children: [_jsx("p", { className: "max-w-md text-sm font-light leading-relaxed text-[#D7E2EA]/60", children: "Selecciona talla y a\u00F1ade la variante al carrito. La conexi\u00F3n final con stock y proveedor se realizar\u00E1 desde nuestra tienda." }), _jsxs("button", { type: "button", onClick: () => onAdd(product.id, size), className: "group relative z-30 inline-flex min-h-14 w-full touch-manipulation items-center justify-center gap-3 rounded-full px-7 text-xs font-semibold uppercase tracking-[0.16em] text-white transition active:scale-[.98] sm:w-auto sm:shrink-0 sm:hover:scale-[1.03]", style: { backgroundColor: product.panel }, children: ["Add to bag ", _jsx(ShoppingBag, { size: 18 })] })] })] })] }) }) }));
}
...
function Footer({ onOpenCart, cartCount }) {
    return (_jsx("footer", { id: "contact", className: "bg-[#0C0C0C] px-5 pb-8 pt-20 text-[#D7E2EA] sm:px-8 md:px-10", children: _jsxs("div", { className: "mx-auto max-w-7xl border-t border-white/15 pt-8", children: [_jsxs("div", { className: "grid gap-10 md:grid-cols-[1.4fr_.6fr_.6fr]", children: [_jsxs("div", { children: [_jsx("img", { src: "./assets/iti-logo.png", alt: "ITI", className: "h-24 w-24 object-contain" }), _jsx("p", { className: "mt-5 max-w-sm text-sm font-light uppercase leading-relaxed tracking-[0.13em] text-white/50", children: "Motor culture translated into streetwear." })] }), _jsxs("div", { className: "grid content-start gap-3 text-sm uppercase tracking-[0.16em]", children: [_jsx("p", { className: "mb-2 text-[10px] text-white/35", children: "Explore" }), _jsx("a", { href: "#story", className: "hover:opacity-60", children: "About" }), _jsx("a", { href: "#system", className: "hover:opacity-60", children: "Drop 01" }), _jsx("a", { href: "#shop", className: "hover:opacity-60", children: "Shop" }), _jsxs("button", { type: "button", onClick: onOpenCart, className: "text-left uppercase hover:opacity-60", children: ["Bag (", cartCount, ")"] })] }), _jsxs("div", { className: "grid content-start gap-3 text-sm uppercase tracking-[0.16em]", children: [_jsx("p", { className: "mb-2 text-[10px] text-white/35", children: "Social" }), _jsxs("a", { href: "https://www.instagram.com/itinocontext/", target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-2 hover:opacity-60", children: ["Instagram ", _jsx(Instagram, { size: 15 })] }), _jsx("a", { href: "mailto:hello@iti-store.com", className: "hover:opacity-60", children: "Contact" }), _jsxs("a", { href: "#top", className: "inline-flex items-center gap-2 hover:opacity-60", children: ["Back to top ", _jsx(ArrowRight, { size: 15, className: "-rotate-90" })] })] })] }), _jsxs("div", { className: "mt-20 flex flex-col gap-3 border-t border-white/10 pt-5 text-[10px] uppercase tracking-[0.2em] text-white/35 sm:flex-row sm:items-center sm:justify-between", children: [_jsx("p", { children: "ITI \u00A9 2026" }), _jsx("p", { children: "Spain / EUR" }), _jsx("p", { children: "Drop 01 \u2014 No Context" })] })] }) }));
}
